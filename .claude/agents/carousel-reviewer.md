...
8. 인스타 핸들 오타 (`@dr.soa_unnie`가 정확 — `drsoa_unnie` / `dr_soa_unnie` 등은 오타)
...
| 4 | **Cover 후킹 강도** | carousel-structure.md 4가지 패턴(통념 깨기·기준 제시·위험 신호·궁금증 해소) 중 하나? + 헤드라인 위 `✓ 소아청소년과 전문의` 강조 배지 존재 여부(누락 시 치명 감점) |
