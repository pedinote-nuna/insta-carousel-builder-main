...
> 이 레포는 **소아과언니(@soagwa_unnie)** 브랜드의 인스타 카드뉴스를 Claude Code에서 직접 제작하는 도구입니다.
...
5. **인스타 핸들**: 정확히 `@soagwa_unnie` (소-아-과 순서). ❌ `sowaga_unnie` / `soakwa_unnie` 등 전부 오타.
...
| 4 | **Cover 후킹** | [carousel-structure.md](knowledge/patterns/carousel-structure.md) 의 4가지 패턴(통념 깨기·기준 제시·위험 신호·궁금증 해소) 중 하나 |
